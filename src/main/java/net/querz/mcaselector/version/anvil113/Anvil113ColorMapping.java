...
public class Anvil113ColorMapping implements ColorMapping {
	...
	public Anvil113ColorMapping() {
		...
		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(Anvil113ColorMapping.class.getClassLoader().getResourceAsStream("mapping/113/colors.txt"))))) {
			String line;
		...
		try (BufferedReader bis = new BufferedReader(
			new InputStreamReader(Objects.requireNonNull(ColorMapping.class.getClassLoader().getResourceAsStream("mapping/113/biome_colors.txt"))))) {
			...
			throw new RuntimeException("failed to read mapping/113/biome_colors.txt");
		}
	}
	...
	public int getRGB(Object o, String biome) {
		throw new UnsupportedOperationException("color mapping for 1.13 does not support biome names");
	}
