...
public class Anvil115ColorMapping implements ColorMapping {
	...
	private static final Logger LOGGER = LogManager.getLogger(Anvil115ColorMapping.class);
	...
	public Anvil115ColorMapping() {
		...
		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(Anvil115ColorMapping.class.getClassLoader().getResourceAsStream("mapping/115/colors.txt"))))) {
			String line;
