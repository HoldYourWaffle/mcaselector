...
public enum Translation {
	...
	MENU_TOOLS_BIOME_SELECTOR("menu.tools.biome_selector"),
	...
	DIALOG_BIOME_SELECTOR_TITLE("dialog.biome_selector.title"),
	...
	DIALOG_PROGRESS_TITLE_SELECTING_BIOMES("dialog.progress.title.selecting_biomes"),
